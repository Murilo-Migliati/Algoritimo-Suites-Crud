...
namespace Algoritimo_Suites.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        public async Task<IActionResult> DetalhesFuncionario(int? id)
        {
            if (id == null)
            {
                return NotFound();
        ...
        public async Task<IActionResult> NovoFuncionario([Bind("Id,Name")] Funcionario funcionario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> EditarFuncionario(int id, [Bind("Id,Name")] Funcionario funcionario)
        {
